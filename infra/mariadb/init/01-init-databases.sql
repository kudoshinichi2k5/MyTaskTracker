...
CREATE USER IF NOT EXISTS 'auth_service'@'%' IDENTIFIED BY '123';
GRANT ALL PRIVILEGES ON tracker_auth.* TO 'auth_service'@'%';

CREATE USER IF NOT EXISTS 'task_service'@'%' IDENTIFIED BY '123';
GRANT ALL PRIVILEGES ON tracker_tasks.* TO 'task_service'@'%';

CREATE USER IF NOT EXISTS 'notification_service'@'%' IDENTIFIED BY '123';
GRANT ALL PRIVILEGES ON tracker_notifications.* TO 'notification_service'@'%';

CREATE USER IF NOT EXISTS 'project_service'@'%' IDENTIFIED BY '123';
GRANT ALL PRIVILEGES ON tracker_projects.* TO 'project_service'@'%';

CREATE USER IF NOT EXISTS 'comment_service'@'%' IDENTIFIED BY '123';
